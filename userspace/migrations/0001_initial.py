...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userspace_userprofile', (
            ...
            ('birth_date', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('rank_pts', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
