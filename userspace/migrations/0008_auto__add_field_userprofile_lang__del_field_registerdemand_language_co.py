...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.lang'
        db.add_column(u'userspace_userprofile', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='en-us', max_length=10),
                      keep_default=False)

        # Deleting field 'RegisterDemand.language_code'
        db.delete_column(u'userspace_registerdemand', 'language_code')

        # Adding field 'RegisterDemand.lang'
        db.add_column(u'userspace_registerdemand', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='en-us', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.lang'
        db.delete_column(u'userspace_userprofile', 'lang')

        # Adding field 'RegisterDemand.language_code'
        db.add_column(u'userspace_registerdemand', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='en-us', max_length=5),
                      keep_default=False)

        # Deleting field 'RegisterDemand.lang'
        db.delete_column(u'userspace_registerdemand', 'lang')
    ...
    models = {
        ...
        u'userspace.registerdemand': {
            ...
            'lang': ('django.db.models.fields.CharField', [], {'default': "'en-us'", 'max_length': '10'}),
