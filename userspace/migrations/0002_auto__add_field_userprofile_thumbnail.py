...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userspace_userprofile', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='img/avatars/30x30_anonymous.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.thumbnail'
        db.delete_column(u'userspace_userprofile', 'thumbnail')
    ...
    models = {
        ...
        u'userspace.userprofile': {
            ...
            'rank_pts': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
