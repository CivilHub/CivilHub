...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.lang'
        db.alter_column(u'userspace_userprofile', 'lang', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'UserProfile.gender'
        db.alter_column(u'userspace_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.lang'
        db.alter_column(u'userspace_userprofile', 'lang', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'UserProfile.gender'
        db.alter_column(u'userspace_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
