...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisterDemand.email'
        db.add_column(u'userspace_registerdemand', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegisterDemand.email'
        db.delete_column(u'userspace_registerdemand', 'email')
