...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Idea.description'
        db.alter_column(u'ideas_idea', 'description', self.gf('django.db.models.fields.TextField')(max_length=20480, null=True))

    def backwards(self, orm):

        # Changing field 'Idea.description'
        db.alter_column(u'ideas_idea', 'description', self.gf('django.db.models.fields.TextField')(max_length=2048, null=True))
