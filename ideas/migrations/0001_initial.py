...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ideas_category', (
        ...
        db.create_table(u'ideas_idea', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ideas.Category'], null=True, blank=True)),
        ...
        db.create_table(u'ideas_vote', (
            ...
            ('date_voted', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'ideas', ['Vote'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'ideas_category')

        # Deleting model 'Idea'
        db.delete_table(u'ideas_idea')

        # Deleting model 'Vote'
        db.delete_table(u'ideas_vote')
