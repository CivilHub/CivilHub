...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ideas_category', (
            ...
            ('description_af', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ar', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_az', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_bg', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_be', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_bn', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_br', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_bs', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ca', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_cs', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_cy', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_da', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_de', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_el', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_en', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_en_gb', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_eo', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_es', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_es_ar', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_es_mx', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_es_ni', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_es_ve', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_et', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_eu', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_fa', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_fi', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_fr', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_fy_nl', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ga', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_gl', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_he', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_hi', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_hr', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_hu', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ia', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_id', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_is', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_it', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ja', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ka', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_kk', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_km', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_kn', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ko', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_lb', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_lt', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_lv', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_mk', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ml', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_mn', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_my', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_nb', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ne', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_nl', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_nn', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_os', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_pa', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_pl', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_pt', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_pt_br', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ro', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ru', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_sk', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_sl', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_sq', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_sr', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_sr_latn', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_sv', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_sw', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ta', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_te', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_th', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_tr', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_tt', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_udm', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_uk', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_ur', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_vi', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_zh_cn', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
            ('description_zh_tw', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
        ))
        ...
        db.create_table(u'ideas_idea', (
            ...
            ('description', self.gf('django.db.models.fields.TextField')(max_length=20480, null=True, blank=True)),
    ...
    models = {
        ...
        u'ideas.idea': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'max_length': '20480', 'null': 'True', 'blank': 'True'}),
