...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'geobase_country', (
            ...
            ('location', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['locations.Location'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'geobase', ['Country'])


    def backwards(self, orm):
        # Deleting model 'Country'
        db.delete_table(u'geobase_country')
