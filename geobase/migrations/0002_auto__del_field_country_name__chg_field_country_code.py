...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'geobase_country', 'name')


        # Changing field 'Country.code'
        db.alter_column(u'geobase_country', 'code', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):
        # Adding field 'Country.name'
        db.add_column(u'geobase_country', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


        # Changing field 'Country.code'
        db.alter_column(u'geobase_country', 'code', self.gf('django.db.models.fields.CharField')(max_length=4))
