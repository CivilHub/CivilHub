...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.intro'
        db.add_column(u'topics_discussion', 'intro',
                      self.gf('django.db.models.fields.TextField')(default='Lorem Ipsum'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.intro'
        db.delete_column(u'topics_discussion', 'intro')
