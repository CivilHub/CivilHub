...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'topics_category', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Category.description'
        db.alter_column(u'topics_category', 'description', self.gf('django.db.models.fields.TextField')(null=True))
