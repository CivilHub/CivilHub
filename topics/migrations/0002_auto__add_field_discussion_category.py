...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.category'
        db.add_column(u'topics_discussion', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['topics.Category'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field categories on 'Discussion'
        db.delete_table(db.shorten_name(u'topics_discussion_categories'))


    def backwards(self, orm):
        # Deleting field 'Discussion.category'
        db.delete_column(u'topics_discussion', 'category_id')

        # Adding M2M table for field categories on 'Discussion'
        m2m_table_name = db.shorten_name(u'topics_discussion_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('discussion', models.ForeignKey(orm[u'topics.discussion'], null=False)),
            ('category', models.ForeignKey(orm[u'topics.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['discussion_id', 'category_id'])
