...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Discussion', fields ['question']
        db.create_unique(u'topics_discussion', ['question'])

        # Adding unique constraint on 'Discussion', fields ['slug']
        db.create_unique(u'topics_discussion', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Discussion', fields ['slug']
        db.delete_unique(u'topics_discussion', ['slug'])

        # Removing unique constraint on 'Discussion', fields ['question']
        db.delete_unique(u'topics_discussion', ['question'])
