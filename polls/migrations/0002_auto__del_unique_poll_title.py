...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Poll', fields ['title']
        db.delete_unique(u'polls_poll', ['title'])


    def backwards(self, orm):
        # Adding unique constraint on 'Poll', fields ['title']
        db.create_unique(u'polls_poll', ['title'])
