...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'polls_poll_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('poll', models.ForeignKey(orm[u'polls.poll'], null=False)),
            ('category', models.ForeignKey(orm[u'polls.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['poll_id', 'category_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'polls_poll_categories'))
    ...
    models = {
        ...
        u'polls.poll': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['polls.Category']", 'null': 'True', 'blank': 'True'}),
