...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'polls_question', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Question.help_text'
        db.alter_column(u'polls_question', 'help_text', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
