...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_category', (
            ...
            ('description', self.gf('django.db.models.fields.TextField')(default='', max_length=1024, null=True, blank=True)),
        ))
        db.send_create_signal(u'blog', ['Category'])

        # Adding model 'News'
        db.create_table(u'blog_news', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64)),
            ('content', self.gf('django.db.models.fields.TextField')(max_length=10248, null=True, blank=True)),
        ...
        db.send_create_signal(u'blog', ['News'])
