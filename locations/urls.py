...
urlpatterns = patterns('',
    ...
    url(r'^(?P<location_slug>[\w-]+)/ideas/(?P<slug>[\w-]+)/vote-summary/(?P<status>[\d]+)/', idea_views.IdeasVoteCommentSummary.as_view(), name='idea-vote-summary'),
    ...
    url(r'^(?P<location_slug>[\w-]+)/projects/(?P<slug>[\w-]+)/active-group/(?P<group_id>\d+)/', project_views.ProjectDetailView.as_view(), name='group_details'),
    ...
    url(r'background/upload/(?P<pk>\d+)/', LocationBackgroundUploadView.as_view(), name='upload-background'),
    url(r'background/(?P<slug>[\w-]+)/', LocationBackgroundView.as_view(), name='background'),
