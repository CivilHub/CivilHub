...
// Press @ to get userlist. Scripts that handles simple macro. We can connect
// with server and fetch list of users that first or last name matches text
// in input box (textarea as well as text inputs are supported).
//
// The only mandatory option is the `el` option as in regular Backbone views.
// Only this way we can bind plugin with DOM element. So the simples use case
// will be something like:
//
// var aa = new ActiveArea({ el: '#my-text-area' });
//
// And that's all! Plugin itself doesn't provide any 'default' template.
